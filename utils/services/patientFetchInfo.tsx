...
export async function getPatientDashboardStatistics(id: string) {
  try {
    ...
    console.log(error);
    return { success: false, message: "Internal Server Error", status: 500 }; //Error
  }
}
...
export async function getPatientById(id: string) {
  try {
    ...
    //If there's is no patient
    // a status code of 200 indicates that the request was successful and the server has returned the requested information.
