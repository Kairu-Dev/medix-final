/*
  ...
  - You are about to drop the column `data_of_birth` on the `Patient` table. All the data in the column will be lost.
...
*/
-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'NURSE', 'DOCTOR', 'PHYSICAL_THERAPIST', 'LAB_TECHNICIAN', 'PATIENT', 'CASHIER');
...
-- AlterTable
ALTER TABLE "Patient" DROP COLUMN "data_of_birth",
