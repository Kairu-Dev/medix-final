    ...
    >
        <td className="flex items-center gap-4 p-4">
            ...
            <div>
                ...
                <span className="text-sm capitalize text-emerald-300/80">{item?.specialization}</span>
            </div>
        </td>

        <td className="hidden md:table-cell text-emerald-200/90">{item?.license_number}</td>
    ...
    return (
        <div className="py-6 px-3 2xl:px-6 bg-gray-900/60 border border-emerald-500/40 rounded-xl shadow-lg relative backdrop-blur-sm">
            ...
            <div className="mt-6 bg-gradient-to-b from-emerald-50/15 to-emerald-900/30 rounded-xl p-4 border border-emerald-500/40 shadow-md backdrop-blur-sm relative">
                ...
                <h2 className="text-lg font-bold text-white tracking-wider pl-2 font-mono uppercase mb-4">Doctor Registry</h2>
...
const DoctorsList = async(props: SearchParamsProps) => {
    ...
    return (
        <div className="bg-black-800 rounded-xl py-6 px-3 2xl:px-6">
