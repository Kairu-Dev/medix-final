...
const DoctorDashboard = async() => {
  ...
  const {
    totalPatient, totalNurses, totalAppointment, appointmentCounts, availableDoctors, monthlyData, last5Records
  } = await getDoctorDashboardStatistics();
  ...
  const cardData = [
    ...
    },
    {
      ...
      className: "bg-gradient-to-br from-amber-400/20 to-amber-600/10",
      iconClassName: "bg-amber-400/25 text-amber-100",
    ...
    },
    {
      ...
      className: "bg-gradient-to-br from-emerald-400/20 to-emerald-600/10",
      iconClassName: "bg-emerald-400/25 text-emerald-100",
      ...
      <div className="bg-black-800 rounded-xl p-4 mb-8 border border-amber-200/30 backdrop-blur-sm shadow-lg relative overflow-hidden">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-white text-xl xl:text-2xl font-extrabold tracking-wide leading-tight"> Welcome, <span className="text-amber-100">Dr. {user?.firstName}</span></h1>
          </div>
...
const cardData = [
  ...
  return <div className="rounded-xl py-6 px-3 flex flex-col xl:flex-row gap-6">
    ...
    <div className="w-full xl:w-[69%]">
      ...
      <div className="bg-black-800 rounded-xl p-4 mb-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-white header xl:text-2xl font-semibold"> Welcome, Dr. {user?.firstName}</h1>
